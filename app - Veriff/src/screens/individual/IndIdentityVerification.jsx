  ...
  const handleLaunchSdk = async () => {
    ...
    try {
      const initParams = {
        ...
        production: false,
        // Veriff Test Journey: keep the desktop flow rather than the
        // "continue on phone" mobile hand-off. The Alloy SDK exposes a single
        // mobile/desktop toggle (`forceMobile`); false keeps document capture
        // inside the desktop Veriff modal so we can upload docs there.
        forceMobile: false,
        evaluationData: {
          ...
          <>
            ...
            <div className="button-group">
              ...
              <button
                ...
                onClick={() => { setStatus('success'); setTimeout(() => goNext(), 1200) }}
                disabled={status === 'loading'}
