...
export default function App() {
  ...
  return (
    <div className="phone-frame-wrapper">
      {/* Dev Tools panel intentionally hidden for embedded/iframe usage. The host
          app drives flow selection and prefill via URL params + postMessage, so
          the in-widget debug overlay is redundant. Source kept below in a dead
          block in case we want to re-enable it for standalone dev. */}
      {false && (
