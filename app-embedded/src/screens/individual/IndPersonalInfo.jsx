...
export default function IndPersonalInfo({ formData, dispatch, goNext, goBack, contextId, flowType }) {
  ...
  const validate = () => {
    ...
    else if (taxId.replace(/\D/g, '').length !== 9) errs.taxId = 'SSN must be 9 digits'
    setErrors(errs)
  ...
  // Format DOB as MM/DD/YYYY while typing. Strip non-digits, cap at 8 digits,
  // then re-insert slashes after positions 2 and 4. Backspace works naturally
