        ...
        {loading ? (
          ...
          <>
            <div className="card" style={{ flex: 1 }}>
              ...
              <h1 style={{ textAlign: 'center' }}>Delio Verification</h1>
              <p className="subtitle" style={{ textAlign: 'center' }}>
                You are about to submit sensitive personal and business data to <strong>Delio</strong> for the purpose of identity and entity verification.
              </p>
              <div style={{
                background: '#FFF7ED',
